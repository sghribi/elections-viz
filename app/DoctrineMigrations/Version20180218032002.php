 ...
 */
class Version20180218032002 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE commune (id INT NOT NULL, departement_id INT NOT NULL, code VARCHAR(3) NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E2E2D1EECCF9E01E ON commune (departement_id)');
        $this->addSql('CREATE TABLE departement (id INT NOT NULL, region_id INT NOT NULL, code VARCHAR(3) NOT NULL, codeMin VARCHAR(3) NOT NULL, code3Car VARCHAR(3) NOT NULL, numOrdre INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
